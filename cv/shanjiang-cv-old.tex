  ...
  \cventry
    ...
    {Jun 2020 - Sep 2020}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Productionized} 5K+ lines of code and improved precision@recall=90\% of production models by up to \entrylocationstyle{10\%}.}
      \end{cvitems}
    }
  \cventry
    ...
    {Jun 2019 - Aug 2019}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Productionized} 5K+ lines of code with test files and technical documentation and published a paper at \entrylocationstyle{WWW'20}.}
      \end{cvitems}
    }
  \cventry
