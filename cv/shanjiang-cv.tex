  ...
  \cventry
    ...
    {Jun 2020 - Sep 2020}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Productionized} 5K+ lines of code and improved the performance of production models by up to \entrylocationstyle{2\%}.}
      \end{cvitems}
    }
  \cventry
    ...
    {Jun 2019 - Aug 2019}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Productionized} 5K+ lines of code with test files and technical documentation.}
        \item {Published a paper with additional data exploration and model comparison at \entrylocationstyle{WWW'20}.}
      \end{cvitems}
    }
  \cventry
  ...
  \cventry
    ...
    {Sep 2016 - Present}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Award-winning} publications at top web (e.g., \entrylocationstyle{WWW'18/19}, \entrylocationstyle{ICWSM'19/20}), HCI (e.g., \entrylocationstyle{CSCW'18}) and AI (e.g., \entrylocationstyle{AAAI'20}, \entrylocationstyle{FAccT'19/21}) conferences.}
      \end{cvitems}
    }
  \cventry
  ...
  \cventry
    ...
    {Oct 2013 - Dec 2015}
    {
      \begin{cvitems}
        ...
        \item {Published papers at computer network and system conferences, e.g., \entrylocationstyle{GlobeCom'15}, \entrylocationstyle{LCN'15}, \entrylocationstyle{ICPADS'14}.}
      \end{cvitems}
    }
\end{cventries}
