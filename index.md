...
auditing platforms' interventions such as content moderation ([ICWSM'19](publications/icwsm19_paper.pdf){:target="_blank"}, [AAAI'20](publications/aaai20_paper.pdf){:target="_blank"}) and search ranking ([CSCW'18b](publications/cscw18b_paper.pdf){:target="_blank"}),
extracting structured information from fact-checks ([WWW'20](publications/www20_paper.pdf){:target="_blank"}),
understanding audiences' responses on social media ([CSCW'18a](publications/cscw18a_paper.pdf){:target="_blank"}), etc.
