  ...
  \cventry
    ...
    {Jun 2020 - Sep 2020}
    {
      \begin{cvitems}
        ...
        \item {Improved the performance of production models by up to \entrylocationstyle{2\%} and \entrylocationstyle{productionized} 5K+ lines of code.}
      \end{cvitems}
    }
  \cventry
  ...
  \cventry
    ...
    {Sep 2016 - Present}
    {
      \begin{cvitems}
        ...
        \item {Published \entrylocationstyle{award-winning} papers at top web (e.g., \entrylocationstyle{WWW'18-19}, \entrylocationstyle{ICWSM'19-20}), HCI (e.g., \entrylocationstyle{CSCW'18}) and AI (e.g., \entrylocationstyle{AAAI'20}, \entrylocationstyle{FAT*'19}) conferences.}
      \end{cvitems}
    }
  \cventry
