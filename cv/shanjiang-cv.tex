  ...
  \cventry
    ...
    {Sep 2016 - Present}
    {
      \begin{cvitems}
        ...
        \item {Published \entrylocationstyle{award-winning} research papers at top conferences for natural language processing (e.g., \entrylocationstyle{ACL'21}), computational social science (e.g., \entrylocationstyle{WWW'18/19}, \entrylocationstyle{ICWSM'19/20}), HCI (e.g., \entrylocationstyle{CSCW'18}) and AI (e.g., \entrylocationstyle{AAAI'20}, \entrylocationstyle{FAccT'19/21}).}
      \end{cvitems}
    }
  \cventry
  ...
  \cventry
    ...
    {Oct 2013 - Dec 2015}
    {
      \begin{cvitems}
        ...
        \item {Published research papers at conferences for networks (e.g., \entrylocationstyle{GlobeCom'15}, \entrylocationstyle{LCN'15}) and systems (e.g., \entrylocationstyle{ICPADS'14}).}
      \end{cvitems}
    }
\end{cventries}
