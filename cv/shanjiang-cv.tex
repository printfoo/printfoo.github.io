...
\begin{cventries}
  \cventry
    {Software Engineer Intern (Incoming) @ Content Integrity (Dangerous Content) Team}
    {Facebook}
    {Seattle, WA}
    {Jun 2020 - Sep 2020}
    {
      \begin{cvitems}
        \item {Project: Multimodal learning for dangerous content detection.}
      \end{cvitems}
    }
  \cventry
    {Software Engineer Intern @ Fact Check Team, Google AI}
    {Google}
    {New York, NY}
    {Jun 2019 - Aug 2019}
    {
      \begin{cvitems}
        ...
        \item {\entrylocationstyle{Productionized} 5K+ lines of codebase with test files and technical documentation.}
  ...
  \cventry
    ...
    {Sep 2016 - Present}
    {
      \begin{cvitems}
        ...
        \item {Published \entrylocationstyle{award-winning} papers at top web (e.g., \entrylocationstyle{WWW'18-19}, \entrylocationstyle{ICWSM'19}), HCI (e.g., \entrylocationstyle{CSCW'18}) and AI (e.g., \entrylocationstyle{AAAI'20}, \entrylocationstyle{FAT*'19}) conferences.}
      \end{cvitems}
    }
  \cventry
